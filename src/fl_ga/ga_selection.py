...
def ga_client_selection(num_clients, k=5, pop_size=90, generations=10, local_accs=None, adaptive=True):
    """
    ...
    for gen in range(generations):
        ...
        # Mutation
        population = [mutation(chrom, p_m, num_clients) for chrom in new_population[:pop_size]]
